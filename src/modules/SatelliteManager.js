...
trackNearbySatellites(selectedSatellite) {
  const nearbySatellites = this.detectNearbySatellites(selectedSatellite, 250);  // 1000 km threshold
...
trackSatellite(satellite) {
  ...
  set trackedSatellite(name) {
    ...
    if (selectedSatellite) {
        ...
        this.detectNearbySatellites(selectedSatellite, 250);  // 1000 km threshold
